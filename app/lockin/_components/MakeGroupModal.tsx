...
const  MakeGroupModal: React.FC<MakeGroupModalProps> = ({handleMakeGroup, setVisible}) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full min-h-full flex justify-center md:items-start items-center z-50">
            ...
            {/* Modal Content */}
            <div className="card-outline relative md:w-3/5 w-11/12 bg-appFg p-3  h-fit md:mt-28 text-xl flex flex-col justify-center items-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mt-3 text-center">
                    ...
                    className="bg-appBg px-2 rounded-lg"
                    ...
                    <div className="flex justify-center items-center align-middle space-x-8 mt-3">
                        <button type="submit"  className="p-2 text-center text-appFg rounded-xl font-bold bg-emerald-600 w-fit btn-hover">Create Group!</button>
                        <p onClick={()=>setVisible(false)}  className=" p-2 text-center text-appFg rounded-xl font-bold bg-neutral-400 w-fit btn-hover">Cancel</p>
                    </div>
                </form>
            </div>
        </div>
